...
newUsersAnalysis = np.concatenate((newUsersNames, newUsersRatings, labels), axis=1) #(4 points)
...
newUsersAnalysis = pd.DataFrame(newUsersAnalysis,columns=columnsTitles) #(6 points)
# Display the assignments of each users to a cluster 
newUsersAnalysis
